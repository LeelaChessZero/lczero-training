...
def parse_function(planes, probs, winner, q, plies_left, q_st, opp_probs=None):
    """
    ...
    if opp_probs is not None:
        ...
        opp_probs = -tf.ones_like(probs)

    return (planes, probs, winner, q, plies_left, q_st, opp_probs)
