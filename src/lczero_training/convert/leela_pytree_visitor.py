...
class LeelaPytreeWeightsVisitor:
    def __init__(self, nnx_state: dict, leela_net: net_pb2.Net) -> None:
    ...
    def embedding_block(self, nnx_dict: dict, weights: net_pb2.Weights) -> None:
        self.matmul(
            nnx_dict["preprocess"],
    ...
    def encoder_tower(self, nnx_dict: dict, weights: net_pb2.Weights) -> None:
        ...
        for i in range(len(weights.encoder)):
            self.encoder_block(
                nnx_dict["encoders"]["layers"][i], weights.encoder[i]
            )

    def encoder_block(
        self, nnx_dict: dict, weights: net_pb2.Weights.EncoderLayer
    ) -> None:
    ...
    def mha(self, nnx_dict: dict, weights: net_pb2.Weights.MHA) -> None:
    ...
    def smolgen(self, nnx_dict: dict, weights: net_pb2.Weights.Smolgen) -> None:
    ...
    def policy_head(
        self, nnx_dict: dict, weights: net_pb2.Weights.PolicyHeads
    ) -> None:
    ...
    def value_head(
        self, nnx_dict: dict, weights: net_pb2.Weights.ValueHeads
    ) -> None:
    ...
    def movesleft_head(self, nnx_dict: dict, weights: net_pb2.Weights) -> None:
    ...
    def ffn(self, nnx_dict: dict, ffn: net_pb2.Weights.FFN) -> None:
